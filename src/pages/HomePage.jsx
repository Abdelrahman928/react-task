      ...
      <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4 p-2">
        {products.map(product =>(
          <div key= {product.id} className= "relative flex flex-col items-center justify-center p-8 border-2 border-blue-700 rounded-lg shadow-lg">
            ...
            <p className="truncate w-full text-center">{product.sku}</p>
            <p className="truncate w-full text-center">{product.name}</p>
            <p className="truncate w-full text-center">{product.price}$</p>
            ...
            {product.type === 'furniture' && product.specificAttributes && 
              <p key= {`${product.id}-${product.type}`} className="truncate w-full text-center">
